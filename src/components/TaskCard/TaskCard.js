...
function Task(props) {
  ...
  return (
    <div className="task-card">
      ...
      <div className="task-card__edit" onClick={editTask}>
        <img src={edit} alt="Edit" />
      </div>
      <div className="task-card__time">
        <div
          className="task-card__time-calendar"
          onClick={() => {
            if (props.cell) {
              props.cell(1);
            }
        ...
        <span className="task-card__time-date">
          {getCreateTime(props.info.date)}
        </span>
      </div>

      <div className="task-card__type">
        <img src={type} alt="Task type" />
      </div>
      <div className="task-card__delete" onClick={deleteTask}>
